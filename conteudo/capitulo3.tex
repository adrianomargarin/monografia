...
Atualmente existe um aplicativo \textit{Desktop} do Portal de Algoritmos que serve de interface gráfica para os alunos da \ac{UCS}. Esse aplicativo foi desenvolvido para suprir a necessidade de uma atualização rápida para os alunos, pois \textit{Java Applets} não está sendo suportado pelos navegadores atuais. Ele faz a comunicação com o \textit{software} antigo via \textit{Web Service}.
