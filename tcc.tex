...
\begin{center}
{\setlength{\unitlength}{1cm}\makebox(12,6.5){\parbox[c]{18cm}{\setlength{\parskip}{0.8cm}\center\vskip -1.2cm\LARGE{\bf\\\large Evolução da Ferramenta de Gerenciamento do Portal de Algoritmos da Universidade de Caxias do Sul}\par \normalsize por\par \large Adriano Margarin\par}}}
\end{center}
